    ...
    function bindForm() {
        ...
        form.addEventListener("submit", function (e) {
            ...
            var entry = {
                ...
                privacy: privacyInput ? privacyInput.value : "full",
            ...
            if (grid) {
                grid.insertAdjacentHTML("afterbegin", storyCardHtml(entry));
                var newCard = grid.querySelector(".donate-testimony-card--new");
                if (newCard) {
                    newCard.scrollIntoView({ behavior: "smooth", block: "nearest" });
                    setTimeout(function () { newCard.classList.remove("donate-testimony-card--new"); }, 2000);
                }
            }
