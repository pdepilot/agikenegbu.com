...
(function () {
    ...
    function initRegistrationForm() {
        ...
        form.addEventListener('submit', e => {
            ...
            /* Ready for PHP/MySQL — POST payload structure */
            const payload = {
                ...formData,
                event_id: 'sdtg-2026',
                event_name: 'Send Down Thy Glory 2026',
                registered_at: new Date().toISOString(),
                registration_ref: 'SDTG-' + Date.now().toString(36).toUpperCase()
            };

            form.dataset.lastPayload = JSON.stringify(payload);

            showSuccessModal(payload.registration_ref);
    ...
    function launchConfetti() {
        ...
        const colors = ['#D4AF37', '#F5D061', '#ffffff', '#4a2d7a', '#2d1b4e'];
